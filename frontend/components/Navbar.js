...
const Navbar = () => (
    <nav class="bg-[#DFC2C3] border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-500">
        <div class="container flex flex-wrap justify-between items-center mx-auto ">
            ...
            <div class="hidden w-full md:block md:w-auto" id="mobile-menu ">
                <ul class="flex flex-col mt-0 md:flex-row text-[#656C5C] md:space-x-8 md:mt-0 md:text-sm md:font-medium font-extrabold">
                    <li>
                    ...
                    <li>
                        <Link href="https://web.facebook.com/pyicechh/" class="block py-2 pr-4 pl-3 text-gray-700 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact Us</Link>
                    </li>
                </ul>
            </div>
        </div>
